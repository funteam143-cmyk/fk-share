...
public class MainActivity extends Activity {
    ...
    private TextView navItem(String i,String l,boolean a){LinearLayout b=new LinearLayout(this);b.setOrientation(LinearLayout.VERTICAL);b.setGravity(Gravity.CENTER);TextView x=text(i,28,a?GREEN:MUTED),y=text(l,15,a?GREEN:MUTED);x.setGravity(Gravity.CENTER);y.setGravity(Gravity.CENTER);b.addView(x,lp(60,38));b.addView(y,lp(90,30));return x;}
